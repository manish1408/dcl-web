      ...
      <div className="col-lg-4 col-md-6">
        <div className="single-blog-post-box bg-f4faff">
          <div className="entry-thumbnail">
            <a href="#"><img src="assets/img/blog-image/1.jpg" alt="image" /></a>
          </div>
          <div className="entry-post-content">
            ...
            <a href="#" className="learn-more-btn">Read Story <i data-feather="plus" /></a>
          </div>
        </div>
      </div>
      <div className="col-lg-4 col-md-6">
      ...
      <div className="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
        <div className="single-blog-post-box bg-f4faff">
          ...
          <div className="entry-post-content">
            ...
            <h3>
              <a href="#">Here are the 5 most telling signs of micromanagement</a>
            </h3>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
              do eiusmod...
