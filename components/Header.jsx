...
export default function header() {
  ...
  const router = useRouter();
    ...
    return (
        <header id="header" className={router.pathname != "/" ? "headroom navbar-style-two" : "headroom navbar-color-white"}>
  ...
  <div className="startp-nav">
    <div className="container">
      <nav className="navbar navbar-expand-md navbar-light">
        <a className="navbar-brand" href="/"><img src={router.pathname != "/" ? "assets/img/logo-black.png" : "assets/img/white-logo.png"} alt="logo" /></a>
        <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
          <ul className="navbar-nav nav ml-auto">
            ...
            <li className="nav-item">
              <Link href="/mvp">
                <a className={router.pathname == "/mvp" ? "nav-link active" : "nav-link"} >MVP</a>
              </Link>
            </li>
            <li className="nav-item">
              <Link href="/services">
