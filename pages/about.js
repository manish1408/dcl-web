    ...
    <div>
      ...
      <>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-12">
                <div className="agency-about-content">
                  ...
                  <a href="#" className="btn btn-secondary">Discover More</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="ml-feedback-area ptb-80">
          ...
          <div className="user-shape1"><img src="assets/img/agency-image/user1.png" alt="image" /></div>
          <div className="user-shape2"><img src="assets/img/agency-image/user2.png" alt="image" /></div>
          <div className="user-shape3"><img src="assets/img/agency-image/user3.png" alt="image" /></div>
          <div className="user-shape4"><img src="assets/img/agency-image/user4.png" alt="image" /></div>
          <div className="user-shape5"><img src="assets/img/agency-image/user5.png" alt="image" /></div>
          <div className="user-shape6"><img src="assets/img/agency-image/user6.png" alt="image" /></div>
        </section>
