        ...
        <div className="col-lg-4 col-md-6">
          <div className="single-blog-post-item">
            ...
            <div className="post-content">
              ...
              <h3><Link href="/blogSingle"><a>The security risks of changing package owners</a></Link></h3>
              <Link href="/blogSingle"><a className="read-more-btn">Read More <i data-feather="plus-circle" /></a></Link>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
          <div className="single-blog-post-item">
            ...
            <div className="post-content">
              ...
              <h3><Link href="/blogSingle"><a>Tips to Protecting Your Business and Family</a></Link></h3>
              <Link href="/blogSingle"><a className="read-more-btn">Read More <i data-feather="plus-circle" /></a></Link>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
          <div className="single-blog-post-item">
            ...
            <div className="post-content">
              ...
              <h3><Link href="/blogSingle"><a>Protect Your Workplace from Cyber Attacks</a></Link></h3>
              <Link href="/blogSingle"><a className="read-more-btn">Read More <i data-feather="plus-circle" /></a></Link>
            </div>
          </div>
        </div>
          ...
          <div className="pagination-area">
            <nav aria-label="Page navigation">
              <ul className="pagination justify-content-center">
                <li className="page-item"><Link href="/blog"><a className="page-link">Prev</a></Link></li>
                <li className="page-item active"><Link href="/blog"><a className="page-link">1</a></Link></li>
                <li className="page-item"><Link href="/blog"><a className="page-link">2</a></Link></li>
                <li className="page-item"><Link href="/blog"><a className="page-link">3</a></Link></li>
                <li className="page-item"><Link href="/blog"><a className="page-link">Next</a></Link></li>
              </ul>
            </nav>
          </div>
        </div>
