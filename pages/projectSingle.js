      ...
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-6">
          <div className="project-details-image">
            ...
            <a href="https://www.youtube.com/watch?v=bk7McNUjWgw" className="popup-youtube"><i data-feather="play" /></a>
          </div>
        </div>
        <div className="col-lg-6 col-md-6 col-sm-6">
          <div className="project-details-image">
            <img src="assets/img/works-image/2.jpg" alt="work" />
            <a href="assets/img/works-image/2.jpg" className="popup-btn"><i data-feather="plus" /></a>
          </div>
        </div>
        <div className="col-lg-6 col-md-6 col-sm-6">
          <div className="project-details-image">
            <img src="assets/img/works-image/4.jpg" alt="work" />
            <a href="assets/img/works-image/4.jpg" className="popup-btn"><i data-feather="plus" /></a>
          </div>
        </div>
        <div className="col-lg-6 col-md-6 col-sm-6">
          <div className="project-details-image">
            ...
            <div className="project-details-information">
              ...
              <div className="single-info-box">
                ...
                <ul>
                  ...
                  <li><a href="#"><i data-feather="instagram" /></a></li>
